		...
		if (tempObj.url == url) 
		{
			if (!tempObj.connecting)
			{
				...
				tempObj.socket.onopen = function(e) {
					...
					var newMess =  "TEST;" + '{"header":{"type":"__register","encoding":"JSON","timestamp":' + n + ',"flags":0},"payload":{"name":"TMX UI ' + uiString + '","description":"UI Interface","version":"2.4.0","exeLocation": "/Debug/UIManafer","coreIpAddr": "127.0.0.1","corePort": 24601,"messageTypes": [],"configuration": []}}';
					sendCommand(newMess);
					// Subscribe

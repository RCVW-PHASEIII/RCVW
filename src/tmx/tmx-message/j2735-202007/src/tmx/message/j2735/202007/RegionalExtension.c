...
static asn_CHOICE_specifics_t asn_SPC_regExtValue_specs_3 = {
	sizeof(struct RegionalExtension_120P0__regExtValue),
	offsetof(struct RegionalExtension_120P0__regExtValue, _asn_ctx),
	offsetof(struct RegionalExtension_120P0__regExtValue, present),
	sizeof(((struct RegionalExtension_120P0__regExtValue *)0)->present),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_RegionalExtension_120P0_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RegionalExtension_120P0, regionId),
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct RegionalExtension_120P0, regExtValue),
...
static const ber_tlv_tag_t asn_DEF_RegionalExtension_120P0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RegionalExtension_120P0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* regionId */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* regExtValue */
};
asn_SEQUENCE_specifics_t asn_SPC_RegionalExtension_120P0_specs_1 = {
	sizeof(struct RegionalExtension_120P0),
	offsetof(struct RegionalExtension_120P0, _asn_ctx),
	asn_MAP_RegionalExtension_120P0_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_RegionalExtension_120P0 = {
	"RegionalExtension",
	"RegionalExtension",
	&asn_OP_SEQUENCE,
	asn_DEF_RegionalExtension_120P0_tags_1,
	sizeof(asn_DEF_RegionalExtension_120P0_tags_1)
		/sizeof(asn_DEF_RegionalExtension_120P0_tags_1[0]), /* 1 */
	asn_DEF_RegionalExtension_120P0_tags_1,	/* Same as above */
	sizeof(asn_DEF_RegionalExtension_120P0_tags_1)
		/sizeof(asn_DEF_RegionalExtension_120P0_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_RegionalExtension_120P0_1,
	2,	/* Elements count */
	&asn_SPC_RegionalExtension_120P0_specs_1	/* Additional specs */
};

...
#include <rtcm/RtcmMessageFactory.h>
...
class TmxRtcmEncodedMessage {
	typedef common::types::Array<TmxRtcmMessage *> rtcm_container;

public:
	TmxRtcmEncodedMessage() = default;
	TmxRtcmEncodedMessage(const TmxRtcmEncodedMessage &other): _myMessages(other._myMessages) { }

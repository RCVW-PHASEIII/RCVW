...
var deviceName = "TMX";
var vehicleDisplayLibraryJsVersion = "2.4.1";
// Debug
...
function handleAppMessage(json_obj)
{
    ...
    else if (json_obj.AppId == 10) // RCVW
    {
        ...
        case "23":  // Error
            ...
            {
                if (DebugOutput) console.log("Playing sound");
...
//                    restartRCVWDisplay();
            ...
            if (!activeRCVWAlert)
            {
                ...
                if (DebugOutput) console.log("Starting Display");
...
//    }
    ...
    if (currentActiveRCVWImage != activeRCVWImage)
    {
        ...
        if (DebugOutput) console.log("displayRCVW:" + JSON.stringify(his));

...
ALTER DATABASE `IVP` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `IVP`;
...
CREATE TABLE IF NOT EXISTS `eventLog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table records events generated by every IVP core component and plugin in the IVP platform.  ' AUTO_INCREMENT=1189 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table lists the plugins loaded and available to run on the IVP platform.' AUTO_INCREMENT=435 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table lists the valid message types of every plugin loaded on the IVP platform.' AUTO_INCREMENT=695 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table records the most recent message activity of each active plugin in the IVP system. The data in this table is updated by the IVP plugin monitor core component for every message the plugin monitor receives.' AUTO_INCREMENT=31397 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table records all message activity of each active plugin in the IVP system. The data in this table is updated by each Plugin as part of PluginClient base class implementation.' ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table lists the IVP system configuration parameters used by both core components and plugins to control the behavior of the system.' AUTO_INCREMENT=1540 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table identifies the types of messages generated by each plugin.' AUTO_INCREMENT=18172 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=27521 ;
...
CREATE TABLE IF NOT EXISTS `systemConfigurationParameter` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='This table lists the IVP system configuration parameters used by both core components and plugins to control the behavior of the system.' AUTO_INCREMENT=112 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='The list of accounts that can access the IVP platform via the administrative portal is held in the users table.' AUTO_INCREMENT=2 ;
